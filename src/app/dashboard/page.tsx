        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-8 animate-slide-up">
          <div className="bg-gradient-to-br from-blue-500/20 to-blue-600/10 backdrop-blur-sm rounded-xl p-3 border border-blue-500/20">
            <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', gap: '8px', width: '100%' }}>
              ...
              <span className="text-white font-bold text-base" style={{ marginLeft: 'auto' }}>{businesses.length}</span>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-violet-500/20 to-violet-600/10 backdrop-blur-sm rounded-xl p-3 border border-violet-500/20">
            <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', gap: '8px', width: '100%' }}>
              ...
              <span className="text-white font-bold text-base" style={{ marginLeft: 'auto' }}>{totalBrands}</span>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-emerald-500/20 to-emerald-600/10 backdrop-blur-sm rounded-xl p-3 border border-emerald-500/20">
            <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', gap: '8px', width: '100%' }}>
              ...
              <span className="text-white font-bold text-base" style={{ marginLeft: 'auto' }}>{totalLocations}</span>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-amber-500/20 to-amber-600/10 backdrop-blur-sm rounded-xl p-3 border border-amber-500/20">
            <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', gap: '8px', width: '100%' }}>
              ...
              <span className="text-white font-bold text-base" style={{ marginLeft: 'auto' }}>0</span>
            </div>
          </div>
        </div>
                ...
                >
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <Link
                      ...
                      className="flex items-center gap-1.5 px-2 py-1 text-white/60 hover:text-white hover:bg-white/10 rounded-lg transition text-xs"
                      title="AI Settings"
                    >
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            >
              <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', gap: '12px' }}>
                <div style={{ width: '40px', height: '40px', minWidth: '40px', flexShrink: 0 }} className="bg-violet-500/20 rounded-lg flex items-center justify-center group-hover:bg-violet-500/30 transition">
            ...
            {businesses.length > 0 && (
              ...
              >
                <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', gap: '12px' }}>
                  <div style={{ width: '40px', height: '40px', minWidth: '40px', flexShrink: 0 }} className="bg-blue-500/20 rounded-lg flex items-center justify-center group-hover:bg-blue-500/30 transition">
            ...
            >
              <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', gap: '12px' }}>
                <div style={{ width: '40px', height: '40px', minWidth: '40px', flexShrink: 0 }} className="bg-emerald-500/20 rounded-lg flex items-center justify-center group-hover:bg-emerald-500/30 transition">
